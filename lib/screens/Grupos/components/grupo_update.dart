...
class GrupoUpdate extends StatelessWidget {
  const GrupoUpdate({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Componentes do Grupo',
      theme: ThemeData(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                //     textAlign: TextAlign.center,
                //     decoration: const InputDecoration(
                //       hintText: 'Insira uma imagem do Grupo',
                //       prefixIcon: Padding(
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton.icon(
                      ...
                      label: const Text('Atualizar Grupo'),
                    ),
                  ],
                ),
              ],
